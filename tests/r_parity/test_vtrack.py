...
_CASES: dict[str, tuple] = {
    ...
    "vtrack.sparse_stddev": (_value("test.sparse", "stddev", 10000), GAP_STDDEV),
    ...
    "vtrack.fixedbin.gscreen.result": (_intervs_vtrack(None, 533), GAP_DEFAULT_FUNC),
    ...
    "vtrack.reg_fixedbin_distance_center": (_intervs_vtrack("distance.center", 533), GAP_DIST_CENTER),
    "vtrack.reg_fixedbin_strand1_distance_center_without_param": (_intervs_vtrack("distance.center", 533, strand=1), GAP_DIST_CENTER),
    "vtrack.iterator_533_regression": (_intervs_vtrack("distance.center", 533, strand=-1), GAP_DIST_CENTER),
    "vtrack.iterator_test.sparse_regression": (_intervs_vtrack("distance.center", "test.sparse"), GAP_DIST_CENTER),
    ...
    "vtrack.tracktype_test.fixedbin_iterator_dim0_sshift-130_eshift224_regression": (_iter_dim(dim=0, sshift=-130, eshift=224), GAP_VTRACK_ITER),
    "vtrack.tracktype_test.fixedbin_iterator_sshift-130_eshift224_regression": (_iter_dim(sshift=-130, eshift=224), GAP_VTRACK_ITER),
    "vtrack.tracktype_test.fixedbin_iterator_dim1_gintervals2d_testrects_regression": (_iter_dim(dim=1, scope=_iv2d_rects, it="test.rects"), GAP_2D_ITER),
    "vtrack.fixedbin_dim2_gintervals2d_testrects_regression": (_iter_dim(dim=2, scope=_iv2d_rects, it="test.rects"), GAP_2D_ITER),
    "vtrack.fixedbin_dim1_shifts_gintervals2d_testrects_regression": (_iter_dim(dim=1, sshift=-130, eshift=224, scope=_iv2d_rects, it="test.rects"), GAP_2D_ITER),
