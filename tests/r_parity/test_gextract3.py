...
_CASES = {
    ...
    "gextract.63": (lambda: pm.gextract("test.array", _i1([1, 2], 0, 1000000)), GAP_ARRAY),
    ...
    "gextract.52": (lambda: pm.gextract("2 * test.array + 17", _i1([1, 2], 0, 1000000)), GAP_ARRAY),
    ...
    "gextract.45": (lambda: pm.gextract(["test.fixedbin", "test.array"], _i1([1, 2], 0, 1000000), iterator="test.fixedbin"), GAP_ARRAY),
    ...
    "gextract.38": (lambda: pm.gextract("test.array", _i1([2, 3])), GAP_ARRAY),
    ...
    "gextract.33": (lambda: pm.gextract("test.array", _i1([2, 3]), iterator=120), GAP_ARRAY),
    ...
    "gextract.23": (lambda: pm.gextract("test.array", _i1([2, 3]), iterator="test.fixedbin"), GAP_ARRAY),
    ...
    "gextract.18": (lambda: pm.gextract("test.array", _i1([2, 3]), iterator="test.sparse"), GAP_ARRAY),
    "gextract.15": (lambda: pm.gextract("test.fixedbin", _i1([2, 3]), iterator="test.array"), GAP_ARRAY),
    "gextract.14": (lambda: pm.gextract("test.sparse", _i1([2, 3]), iterator="test.array"), GAP_ARRAY),
    "gextract.13": (lambda: pm.gextract("test.array", _i1([2, 3]), iterator="test.array"), GAP_ARRAY),
