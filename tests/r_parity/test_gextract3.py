...
_CASES = {
    ...
    "gextract.58": (lambda: pm.gextract("test.computed2d", _i2([6, 8], 10000000, 50000000, [1, 3], 30000000, 80000000)), None),
    "gextract.55": (lambda: pm.gextract("test.computed2d", _i2(list(range(1, 21))), band=(-1874356, 234560)), None),
    ...
    "gextract.50": (lambda: pm.gextract("2 * test.computed2d + 17", _i2([6, 8], 10000000, 50000000, [1, 3], 30000000, 80000000)), None),
    ...
    "gextract.43": (lambda: pm.gextract(["test.computed2d", "test.computed2d * 3"], _i2([6, 5], 10000000, 50000000, [8, 9], 30000000, 80000000), iterator="test.computed2d"), None),
