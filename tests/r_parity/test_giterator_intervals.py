...
_CASES = {
    ...
    "4": (lambda: _gi("test.rects", _i2([2, 3]), iterator=(100000, 200000)), GAP_2D_ITER),
    ...
    "23": (lambda: _gi("test.generated_2d_5", intervals=_gi("test.generated_2d_6"), iterator=_gi("test.generated_2d_5")), GAP_2D_ITER),
    "24": (lambda: _gi("test.generated_2d_5", intervals=_gi("test.generated_2d_6"), iterator="test.bigintervs_2d_5"), GAP_2D_ITER),
    "25": (lambda: _gi("test.generated_2d_5", intervals=_gi("test.generated_2d_6"), iterator="test.generated_2d_5"), GAP_2D_ITER),
    "26": (lambda: _gi("test.generated_2d_5", intervals="test.bigintervs_2d_6", iterator=_gi("test.generated_2d_5")), GAP_2D_ITER),
    "27": (lambda: _gi("test.generated_2d_5", intervals="test.bigintervs_2d_6", iterator="test.bigintervs_2d_5"), GAP_2D_ITER),
    "28": (lambda: _gi("test.generated_2d_5", intervals="test.bigintervs_2d_6", iterator="test.generated_2d_5"), None),
    "29": (lambda: _gi("test.generated_2d_5", intervals="test.generated_2d_6", iterator=_gi("test.generated_2d_5")), GAP_2D_ITER),
    "30": (lambda: _gi("test.generated_2d_5", intervals="test.generated_2d_6", iterator="test.bigintervs_2d_5"), GAP_2D_ITER),
    "31": (lambda: _gi("test.generated_2d_5", intervals="test.generated_2d_6", iterator="test.generated_2d_5"), GAP_2D_ITER),
    "32": (lambda: _gi("test.generated_2d_6", "test.bigintervs_2d_5"), None),
    "33": (lambda: _gi("test.generated_2d_6", "test.generated_2d_5"), GAP_2D_ITER),
}
