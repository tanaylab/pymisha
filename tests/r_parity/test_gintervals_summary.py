...
_CASES: dict[str, tuple] = {
    ...
    "summary_test.generated_1d_1_case1": (lambda: S("test.generated_1d_1", _gi("test.generated_1d_2"), iterator=_gi("test.generated_1d_1")), GAP_SUMMARY_ITER),
    "summary_test.generated_1d_1_case2": (lambda: S("test.generated_1d_1", _gi("test.generated_1d_2"), iterator="test.bigintervs_1d_1"), GAP_SUMMARY_ITER),
    "summary_test.generated_1d_1_case3": (lambda: S("test.generated_1d_1", _gi("test.generated_1d_2"), iterator="test.generated_1d_1"), GAP_SUMMARY_ITER),
    "summary_test.generated_1d_1_case4": (lambda: S("test.generated_1d_1", "test.bigintervs_1d_2", iterator=_gi("test.generated_1d_1")), GAP_SUMMARY_ITER),
    "summary_test.generated_1d_1_case5": (lambda: S("test.generated_1d_1", "test.bigintervs_1d_2", iterator="test.bigintervs_1d_1"), GAP_SUMMARY_ITER),
    "summary_test.generated_1d_1_case6": (lambda: S("test.generated_1d_1", "test.bigintervs_1d_2", iterator="test.generated_1d_1"), GAP_SUMMARY_ITER),
    "summary_test.generated_1d_1_case7": (lambda: S("test.generated_1d_1", "test.generated_1d_2", iterator=_gi("test.generated_1d_1")), GAP_SUMMARY_ITER),
    "summary_test.generated_1d_1_case8": (lambda: S("test.generated_1d_1", "test.generated_1d_2", iterator="test.bigintervs_1d_1"), GAP_SUMMARY_ITER),
    "summary_test.generated_1d_1_case9": (lambda: S("test.generated_1d_1", "test.generated_1d_2", iterator="test.generated_1d_1"), GAP_SUMMARY_ITER),
