 ...
 * Supports configurable Markov order k (1..10).
 */
 ...
 *
 * The Markov order k is configurable at init time (1..10, default 5).
 */
...
public:
     ...
     * @param k Markov order (1..10, default 5 for backward compatibility)
     */
    ...
    // Data accessors for Python interface
